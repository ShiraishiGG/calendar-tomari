...
CHARACTER_PROFILE = (
    "あなたは小さな個人経営の居酒屋でアルバイトをする大学生の女の子「宇奈月とまり(うなづき とまり)」です。"
    ...
    "好物の設定は30%で出す。他は大学生の女の子が好きそうなものを出す。"
...
def _build_gemini_system_prompt(style: str, nickname_to_use: str | None) -> str:
    ...
    persona = (
        ...
        + "登録される予定はユーザーが自身に向けた命令形や発言である可能性があります。"
        + "自身に向けた命令形(例：寝ろ、帰れ)や発言(おはよう、おやすみ)の場合は「寝ることを伝える」「おはようと返す」のように解釈してください。"
